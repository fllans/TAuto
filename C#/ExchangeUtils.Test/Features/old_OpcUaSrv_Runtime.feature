@ignore
Feature: OpcUaServer_Runtime

	@fromGate
	@EpicПроверка_Quality			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.iCore2_GoodQual
	...
	@fromGate
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.iCore2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@fromGate
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.iCore2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.cpu715_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.cpu715_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.cpu715_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.cpu850_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.cpu850_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.cpu850_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.GwEx_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.GwEx_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.GwEx_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.GwEx2_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.GwEx2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.GwEx2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.OpcProxy_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.OpcProxy_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.OpcProxy_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.OpcUA_Params_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: OpcUaSrv.OpcUA_Params_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@EpicЧтение_Запись			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: OpcUaSrv.OpcUA_Params_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.Snmp_GoodQual
	Given Шлюзы 'work' в работе
	...
	@ignore
	#104 сделан другим экземпляром
	@fromGate
	@EpicПроверка_Quality			@StoryOpcUa_Server
	@parentSuite2_ExchUtils_OpcUa_Server	@suiteПроверка_Quality
	@critical
    Scenario: OpcUaSrv.iec104_GoodQual
	Given Шлюзы 'work' в работе
