Feature: OpcUaParam
    ...
    Scenario: GwEx2ex.OpcUa_PARAM_TimeStamp
	...
	@critical
    Scenario: GwEx2ex.OpcUa_PARAM_GoodQual
	Given Шлюзы 'work' в работе
	...
	@critical
    Scenario: GwEx2ex.OpcUa_PARAM_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	Scenario: GwEx2ex.OpcUa_PARAM_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
    ...
    Scenario: GwEx1ex.OpcUa_PARAM_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1ex.OpcUa_PARAM_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1ex.OpcUa_PARAM_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	Scenario: GwEx1ex.OpcUa_PARAM_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@critical
    Scenario: MbTcpSlave.OpcUa_PARAM_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: MbTcpSlave.OpcUa_PARAM_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'ModbusTcp_1' в норме
	...
	Scenario: MbTcpSlave.OpcUa_PARAM_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'ModbusTcp_1' в норме
    ...
    Scenario: Slave104.OpcUa_PARAM_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: Slave104.OpcUa_PARAM_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: Slave104.OpcUa_PARAM_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'Iec104_Sp' в норме
	...
	@critical
    Scenario: GwEx1Proxy.OpcUa_PARAM_GoodQual
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1Proxy.OpcUa_PARAM_ReadWrite
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxyGwEx25_1' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'OpcUa_PARAM_BOOL_external'.'Значение'
	Then Проверка чтения и записи значений 'BYTE AnyValues' в 'OpcUa_PARAM_BYTE_external'.'Значение'
	...
	Scenario: GwEx1Proxy.OpcUa_PARAM_WiteList
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxyGwEx25_1' в норме
	Then Проверка записи 'OpcUa_PARAM_BOOL_wr'.'Значение' не в белом списке
	Then Проверка записи 'OpcUa_PARAM_BYTE_wr'.'Значение' не в белом списке
	...
	@critical
    Scenario: GwEx2Proxy.OpcUa_PARAM_GoodQual
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx2Proxy.OpcUa_PARAM_ReadWrite
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxy2GwEx25_2' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'OpcUa_PARAM_BOOL_external'.'Значение'
	Then Проверка чтения и записи значений 'BYTE AnyValues' в 'OpcUa_PARAM_BYTE_external'.'Значение'
	...
	Scenario: GwEx2Proxy.OpcUa_PARAM_WiteList
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxy2GwEx25_2' в норме
	Then Проверка записи 'OpcUa_PARAM_BOOL_wr'.'Значение' не в белом списке
	Then Проверка записи 'OpcUa_PARAM_BYTE_wr'.'Значение' не в белом списке
    ...
    Scenario: OpcUAServer.OpcUa_PARAM_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: OpcUAServer.OpcUa_PARAM_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: OpcUAServer.OpcUa_PARAM_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	Scenario: OpcUAServer.OpcUa_PARAM_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
