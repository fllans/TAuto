@ignore
@Archive
Feature: OpcDaServer_Archive
	
    @ignore
    #https://office.ivtecon.ru/issues/6519
	@fromMirror  @fromGate
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.iCore2_TimeStamp
	...
	Given Связь с 2 устройством 'OpcDa_1' в норме
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.cpu715_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.cpu715_Clust_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.cpu850_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.GwEx_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.GwEx2_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.OpcDa_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.OpcProxy_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.OpcUa_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.Snmp_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryOpcDa_Server
	@parentSuite2_ExchUtils_OpcDa_Server @suiteTimeStamp
    Scenario: OpcDaSrv.iec104_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
