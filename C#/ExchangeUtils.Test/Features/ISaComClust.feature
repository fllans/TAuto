Feature: ISaComClust
    ...
    Scenario: GwEx2ex.cpu715_Clust_TimeStamp
	...
	@critical
    Scenario: GwEx2ex.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	...
	@critical
    Scenario: GwEx2ex.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	Scenario: GwEx2ex.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	#Тест не проходит из-за расхождения по времени больше, чем 00:00:00.5 "Different TimeStamp in the buffer[0]"
	@ignore
	@fromMirror  @fromGate
	@EpicTimeStamp	@StoryGwEx1ex
	@parentSuite2_ExchUtils_GwEx1ex @suiteTimeStamp
    Scenario: GwEx1ex.cpu715_Clust_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1ex.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1ex.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	Scenario: GwEx1ex.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@critical
    Scenario: GwEx1Proxy.cpu715_Clust_GoodQual
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx1Proxy.cpu715_Clust_ReadWrite
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxyGwEx25_1' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'cpu715_Cluster_BOOL_external'.'Значение'
	Then Проверка чтения и записи значений 'BYTE AnyValues' в 'cpu715_Cluster_BYTE_external'.'Значение'
	...
	Scenario: GwEx1Proxy.cpu715_Clust_WiteList
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxyGwEx25_1' в норме
	Then Проверка записи 'cpu715_Cluster_BOOL_wr'.'Значение' не в белом списке
	Then Проверка записи 'cpu715_Cluster_BYTE_wr'.'Значение' не в белом списке
	...
	@critical
    Scenario: GwEx2Proxy.cpu715_Clust_GoodQual
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: GwEx2Proxy.cpu715_Clust_ReadWrite
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxy2GwEx25_2' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'cpu715_Cluster_BOOL_external'.'Значение'
	Then Проверка чтения и записи значений 'BYTE AnyValues' в 'cpu715_Cluster_BYTE_external'.'Значение'
	...
	Scenario: GwEx2Proxy.cpu715_Clust_WiteList
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'VerProxy2GwEx25_2' в норме
	Then Проверка записи 'cpu715_Cluster_BOOL_wr'.'Значение' не в белом списке
	Then Проверка записи 'cpu715_Cluster_BYTE_wr'.'Значение' не в белом списке
    ...
    Scenario: OpcUAServer.cpu715_Clust_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: OpcUAServer.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@critical
    Scenario: OpcUAServer.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
	...
	Scenario: OpcUAServer.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'OPC_UA_1' в норме
