 ...
 Feature: GwE2ex_Runtime
	...
	@critical
    Scenario: GwE2ex.iCore2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	Scenario: GwE2ex.iCore2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.cpu715_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.cpu715_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.cpu715_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.cpu850_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.cpu850_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.cpu850_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.GwEx_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.GwEx2_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.GwEx2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.GwEx2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.OpcDa_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.OpcDa_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDa_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.OpcDa_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDa_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteПроверка_Quality
	@critical
    Scenario: GwE2ex.OpcProxy_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwE2ex.OpcProxy_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwE2ex
	@parentSuite2_ExchUtils_GwE2ex	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwE2ex.OpcProxy_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2ex_1' в норме
