@ignore
Feature: GwEx_Runtime
	
	@fromMirror  @fromGate
	@EpicПроверка_Quality			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.iCore2_GoodQual
	...
	@fromMirror  @fromGate
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.iCore2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@fromMirror  @fromGate
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.iCore2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.cpu715_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.cpu715_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.cpu715_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'cpu715_Cluster_BOOL_external'.'Значение'
	...
	Then Проверка чтения и записи значений 'REAL AnyValues' в 'cpu715_Cluster_LREAL_external'.'Значение'
	...
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.cpu850_Red_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.cpu850_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	Then Проверка чтения и записи значений 'TRUE; FALSE' в 'cpu850_Red_BOOL_external'.'Значение'
	...
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.cpu850_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.OpcProxy_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.OpcProxy_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.OpcProxy_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx	@suiteПроверка_Quality
	@critical
    Scenario: GwEx.OpcUA_Params_GoodQual
	Given Шлюзы 'work' в работе
	...
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx.OpcUA_Params_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx
	@parentSuite2_ExchUtils_GwEx	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx.OpcUA_Params_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx_1' в норме
	...
	@fromMirror  @fromGate
	@EpicПроверка_Quality			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.iCore2_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@fromMirror  @fromGate
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.iCore2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@fromMirror  @fromGate
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.iCore2_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.cpu715_Red_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.cpu715_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	Then Проверка чтения и записи значений 'ULINT AnyValues' в 'cpu715_Red_ULINT_external'.'Значение'
	Then Проверка чтения и записи значений 'REAL AnyValues' в 'cpu715_Red_REAL_external'.'Значение'
	Then Проверка чтения и записи значений 'REAL AnyValues' в 'cpu715_Red_LREAL_external'.'Значение'
	Then Проверка чтения и записи значений 'TIME AnyValues' в 'cpu715_Red_TIME_external'.'Значение'
	Then Проверка чтения и записи значений 'DATE AnyValues' в 'cpu715_Red_DATE_external'.'Значение'
	...
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.cpu715_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.cpu715_Clust_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.cpu715_Clust_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.cpu715_Clust_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.cpu850_Red_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.cpu850_Red_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.cpu850_Red_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.GwEx2_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.OpcDa_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDa_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.OpcProxy_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.OpcProxy_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.OpcProxy_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteПроверка_Quality
	@critical
    Scenario: GwEx2.OpcUA_Params_GoodQual
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteРазрешенные_переменные
	@critical
    Scenario: GwEx2.OpcUA_Params_ReadWrite
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
	...
	@EpicЧтение_Запись			@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2	@suiteЧтение_Запись	@subSuiteЗапись_запрещена
	Scenario: GwEx2.OpcUA_Params_WiteList
	Given Шлюзы 'work' в работе
	Given Связь с устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
	Given Связь с устройством 'GwEx2_1' в норме
