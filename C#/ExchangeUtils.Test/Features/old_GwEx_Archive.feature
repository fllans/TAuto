@ignore
@Archive
Feature: GwEx_Archive
		
	@fromMirror  @fromGate
	@EpicTimeStamp		@StoryGwEx
	@parentSuite2_ExchUtils_GwEx @suiteTimeStamp
    Scenario: GwEx.iCore2_TimeStamp
	...
	@EpicTimeStamp		@StoryGwEx
	@parentSuite2_ExchUtils_GwEx @suiteTimeStamp
    Scenario: GwEx.cpu715_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryGwEx
	@parentSuite2_ExchUtils_GwEx @suiteTimeStamp
    Scenario: GwEx.cpu715_Clust_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryGwEx
	@parentSuite2_ExchUtils_GwEx @suiteTimeStamp
    Scenario: GwEx.cpu850_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	...
	@EpicTimeStamp		@StoryGwEx
	@parentSuite2_ExchUtils_GwEx @suiteTimeStamp
    Scenario: GwEx.OpcProxy_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
   ...
   #Then Сравнение архивных данных 'OpcUa_PARAM_DATE'.'Значение' из 'ArcReciv'
	...
	@fromMirror  @fromGate
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.iCore2_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'ICORE2' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.cpu715_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'cpu715_Red' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.cpu715_Clust_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'cpu715_Cluster' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.cpu850_Red_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'CPU850_RED' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.GwEx2_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'GwExch_2_v1' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.OpcDa_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcDa_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.OpcProxy_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcDaProxy_Subs' в норме
    Given Шлюз 'DataReceiver' в работе
	...
	@EpicTimeStamp		@StoryGwEx2
	@parentSuite2_ExchUtils_GwEx2 @suiteTimeStamp
    Scenario: GwEx2.OpcUa_TimeStamp
	Given Шлюзы 'work' в работе
    Given Архив 'ArcWork' в работе
	Given Связь с 1 устройством 'OpcUa_ASt5000_Lin' в норме
    Given Шлюз 'DataReceiver' в работе
